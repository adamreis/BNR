...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    AHRHypnosisViewController *hvc = [[AHRHypnosisViewController alloc] init];
    
    AHRReminderViewController *rvc = [[AHRReminderViewController alloc] initWithNibName:@"AHRReminderViewController" bundle:nil];
